...
public class ItemRenderer {
	...
	private void transformFirstPersonItem(float equipProgress, float swingProgress) {
		if (Client.instance.settingsManager.getSettingByName("Old Bow").getValBoolean() && mc != null
				&& mc.thePlayer != null && mc.thePlayer.getItemInUse() != null
		...
		if (Client.instance.settingsManager.getSettingByName("Old Rod").getValBoolean() && mc != null
				&& mc.thePlayer != null && mc.thePlayer.getCurrentEquippedItem() != null
		...
		if (Client.instance.settingsManager.getSettingByName("Old Block").getValBoolean() && mc != null
				&& mc.thePlayer != null && mc.thePlayer.isSwingInProgress
				&& mc.thePlayer.getCurrentEquippedItem() != null && !mc.thePlayer.isEating()
...
//                        ((IMixinItemRenderer) parent).callPerformDrinking(entityPlayerSP, partialTicks);
					if (Client.instance.settingsManager.getSettingByName("Old Eat").getValBoolean()) {
				...
				case BLOCK:
					if (Client.instance.settingsManager.getSettingByName("Old Block").getValBoolean()) {
						transformFirstPersonItem(f, f1);
...
//                        ((IMixinItemRenderer) parent).callDoBlockTransformations();
				...
				case BOW:
					if (Client.instance.settingsManager.getSettingByName("Old Bow").getValBoolean()) {
						transformFirstPersonItem(f, f1);
