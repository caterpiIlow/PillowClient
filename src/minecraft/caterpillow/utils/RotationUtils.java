...
public class RotationUtils {
	...
	public static float[] getRotations(Entity entity) {
		...
		double y = entity.posY + (entity.getEyeHeight() / 2.0F);
		return getRotationFromPosition(x, z, y);
	}

	public static float[] getPredictedRotations(Entity entity) {
		double x = entity.posX + entity.posX - entity.lastTickPosX;
		double z = entity.posZ + entity.posZ - entity.lastTickPosZ;
		double y = entity.posY + (entity.getEyeHeight() / 2.0F);
		return getRotationFromPosition(x, z, y);
	}
