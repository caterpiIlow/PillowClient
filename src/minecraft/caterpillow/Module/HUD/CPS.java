...
public class CPS extends Module {
	...
	public void setup() {
		...
		pos = ScreenPosition.fromTopRight(50, 13);
		width = 50;
	...
	public void onEvent2D(Event2D event) {
		...
		if (!Client.instance.moduleManager.getModulesByName("HUDManager").isToggled()) {
			...
			fr.drawStringWithShadow(getCPS() + " : " + getCPSRight(),
	...
	public void renderDummy(ScreenPosition pos) {
		fr.drawStringWithShadow("69 : 42", pos.getAbsoluteX() + (50 - (fr.getStringWidth("69 : 42"))) / 2,
