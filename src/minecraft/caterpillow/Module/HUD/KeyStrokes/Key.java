...
public class Key {
	...
	static final Key JUMP = new Key("---", Minecraft.getMinecraft().gameSettings.keyBindJump, 1, 1, 58, 18);
	static final Key SNEAK = new Key("SNEAK", Minecraft.getMinecraft().gameSettings.keyBindSneak, 1, 1, 58, 18);
