...
//			System.out.println(
//					"pre adjusting bounds: " + ren.getName() + "  " + pos.getAbsoluteX() + ", " + pos.getAbsoluteY());
...
//				System.out.println(
//						"Drawing dummies: " + module.getName() + "  " + pos.getAbsoluteX() + ", " + pos.getAbsoluteY());
...
//			}
	...
	public void onGuiClosed() {
		...
		for (Module module : modules) {
			if (module.getCategory() == Category.HUD && module.isToggled() == true
					&& !module.getName().equalsIgnoreCase("HUDManager")) {
				module.setPos(renderers.get(module));
			}
		}

		Client.instance.moduleManager.getModulesByName("HUDManager").toggle();
...
//		System.out.println("pre adjust bounds " + pos.getAbsoluteX() + "  " + pos.getAbsoluteY());
		pos.setAbsolute(absoluteX, absoluteY);
//		System.out.println("post adjust bounds " + pos.getAbsoluteX() + "  " + pos.getAbsoluteY());
	}
