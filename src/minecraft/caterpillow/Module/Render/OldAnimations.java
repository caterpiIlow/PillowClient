...
//		Client.instance.settingsManager.rSetting(new Setting("Animation", this, "None", options));
		Client.instance.settingsManager.rSetting(new Setting("Old Block", this, true));
		Client.instance.settingsManager.rSetting(new Setting("Old Rod", this, true));
		Client.instance.settingsManager.rSetting(new Setting("Old Bow", this, true));
		Client.instance.settingsManager.rSetting(new Setting("Old Eat", this, true));
	}

	@Override
	public void onDisable() {

		System.out.println("Attempted notifcation");

		Client.instance.notificationManager.show(NotificationType.WARNING, "Warning", "disabling does nothing", 1);
...
//				}
//
//				if (!Client.instance.settingsManager.getSettingByName("Item Held").getValBoolean()) {
