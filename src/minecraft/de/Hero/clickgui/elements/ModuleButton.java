...
public class ModuleButton {
	...
	public ModuleButton(Module imod, Panel pl) {
		...
		/*
		 * Settings wurden zuvor in eine ArrayList eingetragen dieses SettingSystem hat
		 * 3 Konstruktoren je nach verwendetem Konstruktor ndert sich die Value bei
		 * .isCheck() usw. so kann man ganz einfach ohne irgendeinen Aufwand bestimmen
		 * welches Element f r ein Setting ben tigt wird :>
		 */
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		/*
		 * Ist das Module an, wenn ja dann soll #ein neues Rechteck in Gr e des Buttons
		 * den Knopf als Toggled kennzeichnen #sich der Text anders f rben
		 */
	...
	public boolean keyTyped(char typedChar, int keyCode) throws IOException {
		/*
		 * Wenn listening, dann soll der n chster Key (abgesehen 'ESCAPE') als Keybind f
		 * r mod danach soll nicht mehr gewartet werden!
		 */
		if (listening) {
